...
let User = (() => {
    ...
    var User = class {
        ...
        static {
            ...
            _situation_decorators = [ManyToOne(() => Situations, (situations) => situations.users), JoinColumn({ name: "situation_id" })];
        ...
        situation = (__runInitializers(this, _email_extraInitializers), __runInitializers(this, _situation_initializers, void 0));
        createdAt = (__runInitializers(this, _situation_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
